  ...
  return (
    <div className="mx-auto flex min-h-[60vh] w-full max-w-xl flex-col items-center justify-center px-6 text-center">
      ...
      <input
        id="name"
        type="text"
        className="mt-3 w-full rounded-2xl border border-neutral-300 bg-background px-4 py-3 text-center text-base text-neutral-900 outline-none transition focus:border-neutral-900 focus:ring-4 focus:ring-neutral-200 dark:border-neutral-700 dark:text-neutral-50 dark:focus:border-neutral-100 dark:focus:ring-neutral-800"
        value={value}
